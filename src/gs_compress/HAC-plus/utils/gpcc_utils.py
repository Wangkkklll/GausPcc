...
def compress_gaussian_params(
        gaussian_params,
        bin_path,
        gpcc_codec_path='/home/wkl/code/mpeg-pcc-tmc13-release-v23.0-rc2/build/tmc3/tmc3'
):
    """
...
def compress_gpcc(x: torch.Tensor, gpcc_codec_path: str='/home/wkl/code/mpeg-pcc-tmc13-release-v23.0-rc2/build/tmc3/tmc3') -> bytes:
    """
    Compress geometry point cloud by GPCC codec.
    """
...
def decompress_gpcc(strings: bytes, gpcc_codec_path: str='/home/wkl/code/mpeg-pcc-tmc13-release-v23.0-rc2/build/tmc3/tmc3') -> torch.Tensor:
    """
    Decompress geometry point cloud by GPCC codec.
    """
    with TemporaryDirectory() as temp_dir:
